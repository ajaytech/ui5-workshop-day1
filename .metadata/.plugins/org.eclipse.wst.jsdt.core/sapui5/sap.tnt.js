 ...
 * 
 */
sap.tnt.NavigationList.prototype.fireItemSelect = function(mArguments) { return new sap.tnt.NavigationList(); };
 ...
 * 
 */
sap.tnt.NavigationList.prototype.removeAriaDescribedBy = function(vAriaDescribedBy) { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.tnt.NavigationList.prototype.removeAriaLabelledBy = function(vAriaLabelledBy) { return new sap.ui.core.Control(); };

/**
 * Removes a item from the aggregation <code>items</code>.
 * @param {int | string | sap.tnt.NavigationListItem} vItem The itemto remove or its index or id
 ...
 * 
 */
sap.tnt.NavigationListItem.prototype.fireSelect = function(mArguments) { return new sap.tnt.NavigationListItem(); };
 ...
 * 
 */
sap.tnt.SideNavigation.prototype.fireItemSelect = function(mArguments) { return new sap.tnt.SideNavigation(); };
 ...
 * 
 */
sap.tnt.SideNavigation.prototype.setExpanded = function(bExpanded) { return new sap.tnt.SideNavigation(); };
 ...
 *            oMainContent the mainContent to add; to add; if empty, nothing is inserted
