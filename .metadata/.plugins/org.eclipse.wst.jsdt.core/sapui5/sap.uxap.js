 ...
 *            oMapping the mapping to add; to add; if empty, nothing is inserted
 ...
 * 
 */
sap.uxap.BlockBase.prototype.getSelectedView = function() { return new sap.ui.core.Control(); };
 ...
 * @param {int | string | sap.uxap.ModelMapping} vMapping The mappingto remove or its index or id
 ...
 * @param {sap.ui.core.Control} oSelectedView Id of an element which becomes the new target of this selectedView association; alternatively, an element instance may be given
 * @returns {sap.uxap.BlockBase} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
 ...
 * 
 */
sap.uxap.ObjectPageHeader.prototype.fireMarkChangesPress = function(mArguments) { return new sap.uxap.ObjectPageHeader(); };
 ...
 * 
 */
sap.uxap.ObjectPageLayout.prototype.fireEditHeaderButtonPress = function(mArguments) { return new sap.uxap.ObjectPageLayout(); };
 ...
 * 
 */
sap.uxap.ObjectPageLayout.prototype.setBusy = function(bBusy) {  };
