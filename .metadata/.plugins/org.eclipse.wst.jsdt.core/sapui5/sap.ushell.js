 ...
 * 
 */
sap.ushell.components.factsheet.controls.PictureViewer.prototype.setRemovable = function() {  };
...
/**
 * Check the very first navigation occurred. This method can be useful
 * to detect application "cold start" cases.
 * @returns {boolean}
 ...
 * 
 * In order to get user notifications, the notification service issues OData requests<br>
 * to the service defined by the configuration property <code>serviceUrl</code>,<br>
 * for example: "/sap/opu/odata/SAP/ZNS_NOTIFICATIONS_SRV"<br>
 * 
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.executeAction = function(sNotificationId,sActionId) {  };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.getNotifications = function() { return null; };
 ...
 * 
 * The notification service implements a  periodic polling mechanism in order to get updated notifications data for the Notification center.<br>
 * When FLP runs in Fiori Client (i.e. not in the browser), notification service relies on Fiori Client for updates,<br>
 * On service initialization it issues an initial request for notifications data and registers a callback function <br>
 * that is called by Fiori client when a new notification is pushed to the device by notification center.
 * @since 1.32
 * @public
 * 
 */
 ...
 * 
 */
sap.ushell.services.Personalization.prototype.createEmptyContainer = function(sContainerKey,oScope,oComponent) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.Personalization.prototype.delContainer = function(sContainerKey) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.Personalization.prototype.getContainer = function(sContainerKey,oScope,oComponent) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.Personalization.prototype.getGeneratedKey = function() { return ""; };
 ...
 * 
 */
sap.ushell.services.Personalization.prototype.getPersonalizer = function(oPersId,oScope,oComponent) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.PersonalizationContainer.prototype.setItemValue = function(sItemKey,sItemValue) {  };
 ...
 * 
 */
sap.ushell.services.Personalizer = function() {};
/**
 ...
 * 
 */
sap.ushell.ui.launchpad.LoadingDialog.prototype.getLoadAnimationWithInterval = function() { return false; };

/**
 * Returns a metadata object for class sap.ushell.ui.launchpad.LoadingDialog.
 * @returns {sap.ui.base.Metadata} Metadata object describing this class
 * @public
 * @static
 * 
 */
sap.ushell.ui.launchpad.LoadingDialog.getMetadata = function() { return new sap.ui.base.Metadata(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.LoadingDialog.prototype.getText = function() { return new sap.ui.core.URI(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.LoadingDialog.prototype.setLoadAnimationWithInterval = function(bLoadAnimationWithInterval) { return new sap.ushell.ui.launchpad.LoadingDialog(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.LoadingDialog.prototype.setText = function(sText) { return new sap.ushell.ui.launchpad.LoadingDialog(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer = function(sId,mSettings) {};
/**
 * @event
 * @param {sap.ui.base.Event} oControlEvent
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.afterNavigate = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.afterSwitchState = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.navigate = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.addCenterViewPort = function(oCenterViewPort) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.addLeftViewPort = function(oLeftViewPort) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.addRightViewPort = function(oRightViewPort) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.attachAfterNavigate = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.attachAfterSwitchState = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.attachNavigate = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.destroyCenterViewPort = function() { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.destroyLeftViewPort = function() { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.destroyRightViewPort = function() { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.detachAfterNavigate = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.detachAfterSwitchState = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.detachNavigate = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.extend = function(sClassName,oClassInfo,FNMetaImpl) { return function() {}; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.fireAfterNavigate = function(mArguments) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.fireAfterSwitchState = function(mArguments) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.fireNavigate = function(mArguments) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getCenterViewPort = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getDefaultState = function() { return new sap.ushell.ui.launchpad.ViewPortState(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getHeight = function() { return new sap.ui.core.CSSSize(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getInitialCenterViewPort = function() { return ""; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getInitialLeftViewPort = function() { return ""; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getInitialRightViewPort = function() { return ""; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getLeftViewPort = function() { return new Array(); };

/**
 * Returns a metadata object for class sap.ushell.ui.launchpad.ViewPortContainer.
 * @returns {sap.ui.base.Metadata} Metadata object describing this class
 * @public
 * @static
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.getMetadata = function() { return new sap.ui.base.Metadata(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getRightViewPort = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getVisible = function() { return false; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.getWidth = function() { return new sap.ui.core.CSSSize(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.indexOfCenterViewPort = function(oCenterViewPort) { return 0; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.indexOfLeftViewPort = function(oLeftViewPort) { return 0; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.indexOfRightViewPort = function(oRightViewPort) { return 0; };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.insertCenterViewPort = function(oCenterViewPort,iIndex) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.insertLeftViewPort = function(oLeftViewPort,iIndex) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.insertRightViewPort = function(oRightViewPort,iIndex) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.removeAllCenterViewPort = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.removeAllLeftViewPort = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.removeAllRightViewPort = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.removeCenterViewPort = function(vCenterViewPort) { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.removeLeftViewPort = function(vLeftViewPort) { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.removeRightViewPort = function(vRightViewPort) { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.setDefaultState = function(oDefaultState) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.setHeight = function(sHeight) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.setInitialCenterViewPort = function(vInitialCenterViewPort) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.setInitialLeftViewPort = function(vInitialLeftViewPort) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.setInitialRightViewPort = function(vInitialRightViewPort) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.setVisible = function(bVisible) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.ViewPortContainer.prototype.setWidth = function(sWidth) { return new sap.ushell.ui.launchpad.ViewPortContainer(); };


// ---- sap.ushell.ui.launchpad.ViewPortState --------------------------------------------------------------------------

// dummy function to make Eclipse aware of namespace
sap.ushell.ui.launchpad.ViewPortState.toString = function() { return ""; };
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>expand</code> event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>press</code> event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ushell.ui.shell.ToolAreaItem</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>expand</code> event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>press</code> event of this <code>sap.ushell.ui.shell.ToolAreaItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
 ...
 * 
 */
sap.ushell.ui.shell.ToolAreaItem.prototype.fireExpand = function(mArguments) { return new sap.ushell.ui.shell.ToolAreaItem(); };
 ...
 * 
 */
sap.ushell.ui.shell.ToolAreaItem.prototype.firePress = function(mArguments) { return new sap.ushell.ui.shell.ToolAreaItem(); };
 ...
 */
sap.ushell.components.tiles.indicatorTileUtils.odata4analytics.SortOrder.Ascending = undefined;
 ...
 * @memberof sap.ushell.components.tiles.indicatorTileUtils.odata4analytics.SortOrder
 */
sap.ushell.components.tiles.indicatorTileUtils.odata4analytics.SortOrder.Descending = undefined;
 ...
 * @public
 * 
 * @memberof sap.ushell.ui.launchpad.ViewPortState
 */
sap.ushell.ui.launchpad.ViewPortState.Center = undefined;
 ...
 * @memberof sap.ushell.ui.launchpad.ViewPortState
 */
sap.ushell.ui.launchpad.ViewPortState.CenterLeft = undefined;
 ...
 * @memberof sap.ushell.ui.launchpad.ViewPortState
 */
sap.ushell.ui.launchpad.ViewPortState.CenterRight = undefined;
 ...
 * @memberof sap.ushell.ui.launchpad.ViewPortState
 */
sap.ushell.ui.launchpad.ViewPortState.Left = undefined;
 ...
 * @memberof sap.ushell.ui.launchpad.ViewPortState
 */
sap.ushell.ui.launchpad.ViewPortState.LeftCenter = undefined;
 ...
 * @memberof sap.ushell.ui.launchpad.ViewPortState
 */
sap.ushell.ui.launchpad.ViewPortState.Right = undefined;
 ...
 * @memberof sap.ushell.ui.launchpad.ViewPortState
 */
sap.ushell.ui.launchpad.ViewPortState.RightCenter = undefined;
