...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>inputLiveUpdate</code> event of this <code>sap.ndc.BarcodeScannerButton</code>.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>scanFail</code> event of this <code>sap.ndc.BarcodeScannerButton</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ndc.BarcodeScannerButton</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the <code>scanSuccess</code> event of this <code>sap.ndc.BarcodeScannerButton</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ndc.BarcodeScannerButton</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>inputLiveUpdate</code> event of this <code>sap.ndc.BarcodeScannerButton</code>.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>scanFail</code> event of this <code>sap.ndc.BarcodeScannerButton</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Detaches event handler <code>fnFunction</code> from the <code>scanSuccess</code> event of this <code>sap.ndc.BarcodeScannerButton</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * @param {function}
 *            fnFunction The function to be called, when the event occurs
...
/**
 * Fires event <code>inputLiveUpdate</code> to attached listeners.
 * 
 ...
 * 
 */
sap.ndc.BarcodeScannerButton.prototype.fireInputLiveUpdate = function(mArguments) { return new sap.ndc.BarcodeScannerButton(); };

/**
 * Fires event <code>scanFail</code> to attached listeners.
 * @param {Map} [mArguments] The arguments to pass along with the event
 * @returns {sap.ndc.BarcodeScannerButton} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ndc.BarcodeScannerButton.prototype.fireScanFail = function(mArguments) { return new sap.ndc.BarcodeScannerButton(); };

/**
 * Fires event <code>scanSuccess</code> to attached listeners.
 * 
 * Expects the following event parameters:
 * <ul>
 ...
 * 
 */
sap.ndc.BarcodeScannerButton.prototype.fireScanSuccess = function(mArguments) { return new sap.ndc.BarcodeScannerButton(); };
...
/**
 * Gets current value of property <code>provideFallback</code>.
 * 
...
/**
 * Sets a new value for property <code>provideFallback</code>.
 * 
 * If set to true, the button remains visible if the scanner is not available and triggers a dialog to enter bar code.
 * 
